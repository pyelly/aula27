...
escolha_menu = int(input("quantos alunos alunos que cadastra")) #Variavel que guarda qual escolha do usuario
if escolha_menu == 1: #Se for a escolha for para realizar
     #ler entradas do usuario
   cont = 0 #variavel que controla a reptição
   escolha_usuario = int(input()) #Variavel que guarda quantas vazes o codigo vai rodar
